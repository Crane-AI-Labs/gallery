...
fun WarningSignAlertSheet(
    ...
    Column(
        ...
        Column(
            ...
            Text(signName, fontSize = 24.sp, fontWeight = FontWeight.Bold, color = Color.White)
            if (info != null) {
                Spacer(modifier = Modifier.height(4.dp))
                Text(info.description, fontSize = 14.sp, color = Color.White.copy(alpha = 0.9f), lineHeight = 20.sp)
            }
        }

        Column(modifier = Modifier.padding(20.dp)) {
            Text("Please confirm before proceeding", fontSize = 14.sp, color = Color(0xFF444746))
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                Surface(
                    ...
                    color = if (selected == true) OrangeGold else Color.White,
                    modifier = Modifier
                        .weight(1f)
                        .border(1.dp, if (selected == true) OrangeGold else Color(0xFFE0E0E0), RoundedCornerShape(8.dp))
            ...
            Button(
                ...
                Text(
                    ...
                    else if (selected == true) "Confirm & Monitor"
                    else "Confirm",
                    fontSize = 15.sp,
                    fontWeight = FontWeight.Medium,
